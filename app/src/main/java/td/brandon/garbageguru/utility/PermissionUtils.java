...
package td.brandon.garbageguru.utility;
...
public class PermissionUtils {
    ...
    public static boolean permissionGranted(
        ...
        if (requestCode == permissionCode) {
            Log.d("status", "request equals permission code");
            Log.d("status", "" + grantResults.length);
            Log.d("status", "" + grantResults[0]);
            Log.d("status", "" + PackageManager.PERMISSION_GRANTED);
